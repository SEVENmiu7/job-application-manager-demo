    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "right" &&
            "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 right-0 h-full w-3/4 rounded-l-[20px] border-l border-white/60 shadow-[-24px_0_60px_-40px_rgba(15,23,42,0.45)] sm:max-w-sm",
          side === "left" &&
